        ...
        {services.map((svc, idx) => {
          ...
          return (
            <button
              ...
              style={{
                borderColor: selectedId === svc.id ? color : "#EDE9FE",
                background:
            ...
            >
              ...
              {svc.description && (
                <p className="text-xs mb-3" style={{ color: "#6D6A85" }}>
                  {svc.description}
                </p>
              )}
    ...
    <div>
      ...
      <div className="grid lg:grid-cols-5 gap-6">
        <div
          ...
          style={{ background: palette.cream, borderColor: "#EDE9FE" }}
        >
              ...
              <div className="grid grid-cols-2 gap-2 overflow-y-auto max-h-72">
                {timeSlots.map((time) => (
                  <button
                    ...
                    style={{
                      borderColor:
                        selectedTime === time ? palette.teal : "#EDE9FE",
                      background:
    ...
    <div>
      ...
      >
        <div className="p-5" style={{ background: `${color}15` }}>
          ...
          <p className="text-sm" style={{ color: "#6D6A85" }}>
            {service.duration_minutes} min ·{" "}
      ...
      {!isFree && (
        ...
        >
          ...
          <p className="text-xs mt-1" style={{ color: "#6D6A85" }}>
    ...
    <div>
      ...
      <div className="space-y-4">
        ...
        <div
          ...
          style={{
            borderColor: paymentError ? "#e05252" : "#EDE9FE",
            background: "white",
          }}
        >
...
export default function BookingPage() {
    ...
    try {
      ...
      const { error: stripeError, paymentIntent } =
        await stripe.confirmCardPayment(clientSecret, {
          payment_method: {
            card: cardElement,
            billing_details: { name: form.clientName, email: form.clientEmail },
          },
        });
  ...
  return (
    <div
      ...
      style={{
        background: `linear-gradient(180deg, ${palette.cream} 0%, #FAFAF9 100%)`,
      }}
    >
            ...
            <div key={s.n} className="flex items-center gap-2">
              ...
              {i < steps.length - 1 && (
                <div
                  ...
                  style={{ background: step > s.n ? palette.sage : "#EDE9FE" }}
                />
              )}
            </div>
          ))}
